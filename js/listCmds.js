...
module.exports = {
    liCmds : {
        categories: {
            FUN: {
                KILL: "Is killing random people fun...or dangerous..??",
                RESURRECT: "Resurrect dead people!",
                NUKE: "Drop nukes to some place or to some specific people!",
                SETRR: "Wanna secretly rickroll people? Set an secret rickrolling command!",
                SETREPLYBOT: "Setup a funny reply bot to a specific channel. (Text commands): To remove, simply write Tys setreplybot.",
                YEET: "Yeet people off the Earth, fun!!!"
            },
            WELCOMING: {
                SETWELCOMECHANNEL: "Setup a channel where the bot can send welcome messages! (Text commands): To remove, simply write Tys setwelcomechannel.",
                SETWELCOMEIMG: "Customize the welcoming image background to the image you want!",
                SETWELCOMEMESSAGE: "Customize the welcoming message to the message you want! Here's some words that could be useful to you in the message: USER = the member's username, SERVER = this server's name.",
                SETBYEMESSAGE: "Make me say something when a member leaves the server! Here's some words that could be useful to you in the message: USER = the member's username, SERVER = this server's name, TOTALMEMBERS = the total number of members in the server.",
                SETBYECHANNEL: "Customize the channel where I will send a farewell message each time a member leaves!"
            },
            UTILITIES: {
                INFO: "Get the basic infos about the bot.",
                INVITES: "Get the amount of invites a user has."
            }
        }
    },
    getCates: function () {
        let listOfCa = [];
        for (const key in this.liCmds.categories) {
            listOfCa.push(key);
        }
        return listOfCa;
    },
    ...
    generateHelp: async function (interaction){
